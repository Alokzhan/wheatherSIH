...
| **Unforced Peak Preservation** | ✅ YES | Removed post-hoc max scaling; model relies on learned physics loss weights | `train_ddpm_model` & execution | 🟢 Verified & Connected |
...
| **Unique Route Registry** | ✅ YES | [backend/api/main.py](file:///e:/wheatherSIH/backend/api/main.py) (0 duplicate routes, verified via script) | `check_routes.py` script | 🟢 Verified & Connected |
