...
def run_pipeline(config_path: str):
    ...
    # 4. Spherical ST-GNN Trajectory Prediction
    ...
    # 5. Conditional DDPM Downscaling (12 km -> 5 km)
    print("\n[Step 5] Running PyTorch Conditional DDPM Downscaler (12 km -> 5 km)...")
    ...
    print("\n[Step 6] Generating NDRF Operational Disaster Advisory...")
    ...
    # 7. Output Export
    output_path = config['output']['export_json']
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    pipeline_results = {
        "status": "SUCCESS",
        "experiment_name": config['experiment_name'],
        "checkpoints_verified": True,
        "st_gnn_parameters": evidence['st_gnn']['total_parameters'],
        "ddpm_parameters": evidence['ddpm']['total_parameters'],
        "weather_object": object_summary,
        "trajectory": trajectory,
        "downscaled_peak_preservation": peak_preservation,
        "advisory": advisory
    }
    ...
    print(f"\n" + "=" * 80)
    print(f" [SUCCESS] End-to-End Pipeline Execution Completed Successfully!")
